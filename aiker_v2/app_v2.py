#!/usr/bin/env python3
"""
VTX AI Phone System V2 - 主程序
使用llama-cpp-python + Vosk + Piper的技术栈组合
"""
...
# 导入V2的AI服务
from llm_service_llamacpp import LlamaCppService
from stt_service import VoskSTTService, CallTranscriber  
...
class CallHandler(threading.Thread):
    ...
    def __init__(self, call_info: CallInfo, tts_service: PiperTTSService, 
                 llm_service: LlamaCppService, business_data: dict):
...
class CallManager:
    ...
    def __init__(self):
        ...
        self.llm_service: Optional[LlamaCppService] = None
    ...
    def _init_services(self):
        ...
        try:
            ...
            # 初始化LLM服务 (llama-cpp-python)
            self.llm_service = LlamaCppService()
            logger.info("✅ Llama.cpp LLM service initialized")
            
            # 初始化STT服务 (Vosk)
            self.stt_service = VoskSTTService()
            logger.info("✅ Vosk STT service initialized")
    ...
    def get_stats(self) -> dict:
        ...
        with self.lock:
            return {
                ...
                "stt_available": self.stt_service.is_available() if self.stt_service else False,
...
class V2AIPhoneSystem:
    ...
    def _print_status(self):
        ...
        print(f"🎵 Piper TTS: {'✅ Ready' if stats['tts_available'] else '❌ Not Ready'}")
        print(f"🧠 Llama.cpp LLM: {'✅ Ready' if stats['llm_available'] else '❌ Not Ready'}")
        print(f"🎤 Vosk STT: {'✅ Ready' if stats['stt_available'] else '❌ Not Ready'}")
